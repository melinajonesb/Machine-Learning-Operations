...
- [ ] Write unit tests related to the data part of your code (M16) - Kaja 
- [ ] Write unit tests related to model construction and or model training (M16) - Kaja
- [ ] Calculate the code coverage (M16) - Kaja
